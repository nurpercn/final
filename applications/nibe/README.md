# NIBE Markaryd — görüşme paketi

Safety Compliance Engineer (öncelik) ve PED Compliance Engineer ilanları için konuşma hazırlığı.

| Dosya | Ne işe yarar |
|---|---|
| `gorusme_sorulari_ve_cevaplari.md` | Tüm sorular, strateji, İngilizce konuşma metinleri |
| `gorusme_tek_sayfa_pusula.md` | Görüşme anı — sayılar, hikâyeler, söyleme çizgisi |
| `gorusme_sonrasi_mail.md` | Görüşme sonrası teşekkür maili |
