...
% Compile safely even when figures are not in the same folder.
...
\centering
\vspace{8mm}
Figure file not found: \texttt{#2}\\
Place the file in the same folder to display the figure.
\vspace{8mm}
\end{minipage}}%
}%
}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.88\textwidth]{chamber_structure.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.72\textwidth]{duedate_senaryo.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.66\textwidth]{voltage_senaryo.png}
