...
\begin{tabular}{|c|c|p{1.8in}|p{1.05in}|p{0.8in}|c|c|}
\hline
\textbf{Stage} & \textbf{No.} & \textbf{Test name} & \textbf{Temp.} & \textbf{Humidity} & \textbf{Samp.} & \textbf{Days} \\ \hline
1 & 1 & Gas Amount Determination & 43/38/32 C & Ambient & 1 & 10 \\ \hline
2 & 2 & Pull-down & 43/38/32 C & Ambient & All & 5 \\ \hline
3 & 3--5 & Energy Efficiency & 16/25/32 C & Ambient & 1 & 15 \\ \hline
3 & 6--11 & Performance & 10/16/25/32/38/43 C & Ambient & 1 & 10 \\ \hline
4 & 12--13 & Freezing Capacity / Temperature Rise & 25 C & Ambient & 1 & 10/5 \\ \hline
5 & 14--16 & Consumer Usage & 10/25/32 C & Ambient or 85 percent RH & 1 & 15 \\ \hline
\end{tabular}
\vspace{1mm}
...
\hline
\textbf{Chamber} & \textbf{Stations} & \textbf{Temp.} & \textbf{Hum.} & \textbf{Volt.} \\ \hline
T001 & 8  & 1 & 0 & 0 \\ \hline
T002 & 8  & 1 & 1 & 1 \\ \hline
T003 & 8  & 1 & 1 & 1 \\ \hline
T004 & 8  & 1 & 1 & 1 \\ \hline
...
\small
\begin{tabular}{|p{1.65in}|p{4.25in}|}
\hline
\textbf{Symbol} & \textbf{Definition} \\
\hline
\(\mathcal{P},\mathcal{C},\mathcal{T},\mathcal{E}\) & Products, chambers, tests, and environments \\ \hline
\(M_c,h_c,v_c\) & Stations, humidity capability, and voltage capability of chamber \(c\) \\ \hline
\(\mathcal{T}_p,d_p,\nu_p\) & Required tests, due date, and voltage requirement of product \(p\) \\ \hline
\(s_p,S,s_{\min},s_{\max}\) & Sample count, sample vector, and sample bounds \\ \hline
\(e(t),\tau_t,m_{pt}(s_p)\) & Test environment, duration, and induced multiplicity \\ \hline
\(X_c,X\) & Environment assigned to chamber \(c\), and assignment vector \\ \hline
\(W_e(S),W_e^V(S)\) & Total and voltage-sensitive workload in environment \(e\) \\ \hline
\(C_p,T_p,T^{tot},S^{tot}\) & Completion time, tardiness, total tardiness, and total samples \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Policy} & \textbf{Avg. gap} & \textbf{Std. dev.} & \textbf{Best count} & \textbf{Runtime} \\ \hline
0.10 VNS & 29.62 & 44.09 & 25 & 41.3 \\ \hline
0.20 VNS & 18.11 & 31.52 & 27 & 32.1 \\ \hline
0.30 VNS & 23.44 & 30.10 & 18 & 30.4 \\ \hline
0.10--0.20--0.30 VNS & 22.06 & 33.25 & 38 & 66.0 \\ \hline
0.20--0.30 VNS & 14.93 & 27.35 & 36 & 49.7 \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Budget} & \textbf{Avg. gap} & \textbf{Std. dev.} & \textbf{Best count} & \textbf{Runtime} \\ \hline
50 & 13.79 & 29.07 & 18 & 32.6 \\ \hline
100 & 5.65 & 20.06 & 47 & 49.7 \\ \hline
200 & 0.31 & 1.65 & 82 & 85.1 \\ \hline
\end{tabular}
\end{table}
...
\small
\begin{tabular}{|p{2.2in}|c|c|c|c|}
\hline
\textbf{Method} & \textbf{Avg. gap} & \textbf{Std. dev.} & \textbf{Best count} & \textbf{Runtime} \\ \hline
Fixed sample & 361.93 & 198.43 & 0 & 0.1 \\ \hline
No outer reconfiguration & 140.07 & 90.32 & 0 & 17.1 \\ \hline
No VNS diversification & 178.67 & 113.52 & 0 & 0.5 \\ \hline
Selected proposed configuration & 0.00 & 0.00 & 90 & 85.1 \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|c|c|}
\hline
\textbf{Measure} & \textbf{Fixed sample} & \textbf{Proposed} \\ \hline
Average gap & 361.93 & 0.00 \\ \hline
Std. dev. & 198.43 & 0.00 \\ \hline
Best-instance count & 0 & 90 \\ \hline
Average runtime & 0.1 & 85.1 \\ \hline
Average sample count & 150 & 380 \\ \hline
\end{tabular}
\end{table}
