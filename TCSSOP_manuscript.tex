...
The VNS-based diversification mechanism is activated when the outer loop fails to improve the incumbent. Unlike conventional VNS approaches that perturb sequencing or assignment decisions, this mechanism perturbs sample-size decisions and therefore changes the workload structure itself.
